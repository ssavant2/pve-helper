...
BACKUP_INTEGRATION_API_ENABLED = env_bool("BACKUP_INTEGRATION_API_ENABLED", False)
BACKUP_POLICY_TAG_PREFIX = env("BACKUP_POLICY_TAG_PREFIX", "backup-").strip().lower() or "backup-"
