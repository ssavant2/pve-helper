...
import { initClusterRetirement, initClusterUnusedDeletion } from "./cluster-retirement.js";
...
import { initLogForwarderStatus, initLogForwarderTrust } from "./log-forwarder.js";
...
const initPage = (root = document) => {
  ...
  initClusterUnusedDeletion(root);
